...
// v4.43: DownloadForDesktop import removed — TopBrandingBar handles it on desktop only.
import {
...
export function Dashboard() {
  ...
  return (
    <div>
      <AppHeader title="Dashboard" />
      {/* v4.43: Removed <DownloadForDesktop /> — TopBrandingBar handles it on desktop only.
          UPDATE.pdf A6: This button must NOT appear on mobile browsing. */}
