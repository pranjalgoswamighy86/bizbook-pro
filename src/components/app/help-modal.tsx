    ...
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      ...
      >
        ...
        <div className="border-t pt-3 mt-3 sm:mt-4 flex items-center justify-between text-xs text-slate-500 gap-2">
          <span className="hidden sm:inline">BizBook Pro v4.112 — A Product by Tahigo International</span>
          <span className="sm:hidden text-[11px]">v4.112 — Tahigo International</span>
