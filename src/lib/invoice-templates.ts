...
.header{text-align:center;margin-bottom:4mm;border-bottom:3px solid #000;padding-bottom:3mm}
.header h1{font-size:20px;font-weight:900}.header p{font-size:11px;margin-top:2px;font-weight:900}
.inv-meta{text-align:center;margin-bottom:4mm}.inv-meta .inv-no{font-size:16px;font-weight:900}
.inv-meta .inv-date{font-size:12px;font-weight:700}.inv-meta .badge{display:inline-block;padding:3px 10px;border:2px solid #000;font-size:11px;font-weight:900;margin-top:3px}
.parties{margin-bottom:4mm}.party .lbl{font-size:10px;text-transform:uppercase;font-weight:900;border-bottom:1px solid #000;padding-bottom:1px;margin-bottom:2px}
...
.items-tbl th{border-bottom:2px solid #000;padding:4px 3px;font-size:10px;font-weight:900;text-transform:uppercase;text-align:left}
...
.grand-classic{font-size:15px;font-weight:900;border-top:3px solid #000;border-bottom:3px solid #000;padding:5px 0;margin-top:2px}
.due{font-weight:900}
.notes{margin:3mm 0;padding:3mm;border:2px solid #000;font-size:11px;font-weight:700;word-break:break-word}
.qr{text-align:center;margin:3mm 0}.qr img{width:75px;height:75px;border:2px solid #000}.qr .lbl{font-size:11px;font-weight:900;margin-top:2px}
...
.footer{margin-top:5mm;padding-top:2mm;border-top:2px solid #000;text-align:center;font-size:10px;font-weight:700}
...
<div class="totals">${totalsBlock(sale,'#000','classic')}</div>
