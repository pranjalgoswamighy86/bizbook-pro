...
function templateClassic(sale: InvoiceData, tenant: TenantData): string {
  ...
  const logoHtml = tenant.logoUrl && tenant.showLogoInInvoice !== false ? `<img src="${tenant.logoUrl}" alt="Logo" onerror="this.style.display='none'" style="max-height:70px;max-width:180px;margin-bottom:5px;object-fit:contain;"/>` : ''
...
function templateModern(sale: InvoiceData, tenant: TenantData): string {
  ...
  const logoHtml = tenant.logoUrl && tenant.showLogoInInvoice !== false ? `<img src="${tenant.logoUrl}" alt="Logo" onerror="this.style.display='none'" style="max-height:50px;max-width:160px;object-fit:contain;"/>` : ''
...
<div class="parties"><div class="p-box"><div class="lbl">Billed To</div><div class="name">${sale.partyName}</div>${sale.partyAddress ? `<div class="detail">${sale.partyAddress}</div>` : ''}${sale.partyGst ? `<div class="detail">GSTIN: ${sale.partyGst}</div>` : ''}</div></div>
...
function templateMinimal(sale: InvoiceData, tenant: TenantData): string {
  ...
  const logoHtml = tenant.logoUrl && tenant.showLogoInInvoice !== false ? `<img src="${tenant.logoUrl}" alt="Logo" onerror="this.style.display='none'" style="max-height:45px;max-width:140px;object-fit:contain;margin-bottom:8px;"/>` : ''
...
<div class="parties"><div class="p-box"><div class="lbl">To</div><div class="name">${sale.partyName}</div>${sale.partyAddress ? `<div class="detail">${sale.partyAddress}</div>` : ''}${sale.partyGst ? `<div class="detail">GSTIN: ${sale.partyGst}</div>` : ''}</div></div>
...
function templateCorporate(sale: InvoiceData, tenant: TenantData): string {
  ...
  const logoHtml = tenant.logoUrl && tenant.showLogoInInvoice !== false ? `<img src="${tenant.logoUrl}" alt="Logo" onerror="this.style.display='none'" style="max-height:45px;max-width:150px;object-fit:contain;"/>` : ''
...
<div class="content">
<div class="parties"><div class="p-box"><div class="lbl">Customer Details</div><div class="name">${sale.partyName}</div>${sale.partyAddress ? `<div class="detail">${sale.partyAddress}</div>` : ''}${sale.partyGst ? `<div class="detail">GSTIN: ${sale.partyGst}</div>` : ''}</div></div>
...
function templateElegant(sale: InvoiceData, tenant: TenantData): string {
  ...
  const logoHtml = tenant.logoUrl && tenant.showLogoInInvoice !== false ? `<img src="${tenant.logoUrl}" alt="Logo" onerror="this.style.display='none'" style="max-height:50px;max-width:160px;object-fit:contain;margin-bottom:6px;"/>` : ''
